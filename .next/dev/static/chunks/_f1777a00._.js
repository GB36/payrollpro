...
function DashboardPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardPage.useEffect": ()=>{
            ...
            // Calculate stats
            const employees = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getEmployees"])();
            const payrolls = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPayrolls"])();
            const currentMonth = new Date().getMonth() + 1;
            const currentYear = new Date().getFullYear();
            setStats({
                totalEmployees: employees.length,
                activeEmployees: employees.filter({
                    "DashboardPage.useEffect": (e)=>e.status === "Active"
                }["DashboardPage.useEffect"]).length,
                totalPayrolls: payrolls.length,
                thisMonthPayrolls: payrolls.filter({
                    "DashboardPage.useEffect": (p)=>p.payrollPeriod.month === currentMonth && p.payrollPeriod.year === currentYear
                }["DashboardPage.useEffect"]).length
            });
        }
    }["DashboardPage.useEffect"], []);
...
_s(DashboardPage, "5BCLrfT558ze97WvN1VYczAFnPY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=_f1777a00._.js.map