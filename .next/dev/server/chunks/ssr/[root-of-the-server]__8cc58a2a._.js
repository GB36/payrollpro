...
;
const metadata = {
    title: "Payroll - Payroll Management System",
    description: "Comprehensive payroll management system for modern businesses. Manage employees, process payroll, and generate payslips with ease.",
    generator: "v0.app",
    icons: {
        icon: [
            {
